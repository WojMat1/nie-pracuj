...
INSERT INTO companies (id, address, name, size, email) VALUES
  (1, 'Krucza 1, 00-000 Miasto', 'Company Co', 250, 'company@company.com');
...
INSERT INTO advertisements (id, description, expire_date, name, publish_date, salary_from, salary_to, city_id, company_id, seniority_id, technology_id) VALUES
   (1, 'Dascription', '2023-12-29T23:00:00', 'Ogłoszenie na java', '2022-12-29T23:00:00', 1000, 10000, 1, 1, 1, 1);
